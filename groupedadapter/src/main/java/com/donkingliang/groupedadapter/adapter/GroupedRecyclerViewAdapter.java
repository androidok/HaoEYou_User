...
public abstract class GroupedRecyclerViewAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public HashMap<Integer, Boolean> childTag = new HashMap<>();
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mOnHeaderClickListener != null) {
                        mOnHeaderClickListener.onHeaderClick(GroupedRecyclerViewAdapter.this, holder, groupPosition);
                    }
                }
            });
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mOnFooterClickListener != null) {
                        mOnFooterClickListener.onFooterClick(GroupedRecyclerViewAdapter.this, holder, groupPosition);
                    }
                }
            });
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mOnChildClickListener != null) {
                        mOnChildClickListener.onChildClick(GroupedRecyclerViewAdapter.this, holder, groupPosition, 
                                childPosition);
                    }
                }
            });
    ...
    public void insertGroup(int groupPosition) {
        GroupStructure structure = new GroupStructure(hasHeader(groupPosition), hasFooter(groupPosition), 
    ...
    public interface OnChildClickListener {
        void onChildClick(GroupedRecyclerViewAdapter adapter, BaseViewHolder holder, int groupPosition, int 
                childPosition);
    }
}