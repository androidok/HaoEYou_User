...
public class UserProfileActivity extends EMBaseActivity implements OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.rl_nickname:
                ...
                new Builder(this).setTitle(R.string.setting_nickname).setIcon(android.R.drawable.ic_dialog_info)
                        .setView(editText).setPositiveButton(R.string.dl_ok, new DialogInterface.OnClickListener() {

                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        String nickString = editText.getText().toString();
                        if (TextUtils.isEmpty(nickString)) {
                            Toast.makeText(UserProfileActivity.this, getString(R.string.toast_nick_not_isnull), Toast
                                    .LENGTH_SHORT).show();
                            return;
                        }
            ...
            public void onSuccess(EaseUser user) {
                if (user != null) {
                    ...
                    if (!TextUtils.isEmpty(user.getAvatar())) {
                        Glide.with(UserProfileActivity.this).load(user.getAvatar()).placeholder(R.drawable
                                .default_head).into(headAvatar);
                    } else {
                        Glide.with(UserProfileActivity.this).load(R.drawable.default_head).into(headAvatar);
                    }
                }
            }
    ...
    private void uploadHeadPhoto() {
        ...
        builder.setItems(new String[]{getString(R.string.dl_msg_take_photo), getString(R.string.dl_msg_local_upload)
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which) {
                    case 0:
                        Toast.makeText(UserProfileActivity.this, getString(R.string.toast_no_support), Toast
                                .LENGTH_SHORT).show();
                        break;
                    case 1:
    ...
    private void updateRemoteNick(final String nickName) {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                boolean updatenick = DemoHelper.getInstance().getUserProfileManager().updateCurrentUserNickName
                        (nickName);
                ...
                if (!updatenick) {
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(UserProfileActivity.this, getString(R.string.toast_updatenick_fail), Toast
                                    .LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
                    });
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            dialog.dismiss();
                            Toast.makeText(UserProfileActivity.this, getString(R.string.toast_updatenick_success), 
