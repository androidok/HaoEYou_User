...
public class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseHolder<T>> {
    ...
    public void changeContent(List<T> datas) {
    ...
    public BaseRecyclerAdapter(Context context, List<T> mDatas, int mResLayout, Class<? extends BaseHolder<T>> 
    ...
    public BaseHolder<T> onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = Common.inflate(parent.getContext(), parent, mResLayout);
