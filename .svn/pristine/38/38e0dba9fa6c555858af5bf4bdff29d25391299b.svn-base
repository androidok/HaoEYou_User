...
public class FillingActivity extends BaseActivity {
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.title_back:
                LoginActivity.startAction(mContext, Common.ACCOUNT, FillingActivity.TAG);
                finish();
                break;
            case R.id.more:
                /*跳转到MainActivity*/
    ...
    private void addDoc() {
        String jsonBean = new Gson().toJson(new DocAddRequestBean(Common.TOKEN, mIsExercise.getText().toString(), 
                mIsSmoking.getText().toString(), mIsDrinking.getText().toString(), mGeneticHistory.getText().toString
                (), mAllergy.getText().toString(), new DocBean("", mName.getText().toString(), mBirthday.getText()
                .toString(), mTel.getText().toString(), mArea.getText().toString(), (mDepartment.getText().toString()
        ).split(";"))));
