package com.haoeyou.user.widget.progressbar;
...
import static com.haoeyou.user.widget.progressbar.NumberProgressBar.ProgressTextVisibility.Invisible;
import static com.haoeyou.user.widget.progressbar.NumberProgressBar.ProgressTextVisibility.Visible;
...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mReachedBarHeight = attributes.getDimension(R.styleable.NumberProgressBar_progress_reached_bar_height, 
                default_reached_bar_height);
        mUnreachedBarHeight = attributes.getDimension(R.styleable.NumberProgressBar_progress_unreached_bar_height, 
