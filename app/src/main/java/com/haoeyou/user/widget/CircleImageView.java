...
public class CircleImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private int mBorderColor = DEFAULT_BORDER_COLOR;//外形边框的颜色
    private int mBorderWidth = 0;//外形边框的宽度
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowFlag && mFlagText != null) {
            ...
            canvas.drawText(mFlagText, getWidth() / 2, (3 + (int) Math.cos((Math.PI * 5 / 18))) * getHeight() / 4 + 
                    mFlagTextBounds.height() / 3, mFlagTextPaint);
        }
