package com.haoeyou.user.widget;
...
public class CutAvatarView extends android.support.v7.widget.AppCompatImageView {
    ...
    public Bitmap clip(boolean isCircle) {
        ...
        if (isCircle) {
            canvas.drawRoundRect(new RectF(0, 0, 2 * mCircleRadius, 2 * mCircleRadius), mCircleRadius, mCircleRadius,
                    paint);
            paint.setXfermode(new PorterDuffXfermode(Mode.SRC_IN));
        }

        RectF dst = new RectF(-bitmap.getWidth() / 2 + mCircleRadius, -getHeight() / 2 + mCircleRadius, bitmap
                .getWidth() - bitmap.getWidth() / 2 + mCircleRadius, getHeight() - getHeight() / 2 + mCircleRadius);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int sc = canvas.saveLayer(mRectF, null, Canvas.MATRIX_SAVE_FLAG | Canvas.CLIP_SAVE_FLAG | Canvas
                .HAS_ALPHA_LAYER_SAVE_FLAG | Canvas.FULL_COLOR_LAYER_SAVE_FLAG | Canvas.CLIP_TO_LAYER_SAVE_FLAG | 
