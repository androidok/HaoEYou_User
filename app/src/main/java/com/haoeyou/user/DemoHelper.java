...
import com.haoeyou.user.db.DemoDBManager;
import com.haoeyou.user.db.InviteMessgeDao;
import com.haoeyou.user.db.UserDao;
import com.haoeyou.user.domain.EmojiconExampleGroupData;
import com.haoeyou.user.domain.InviteMessage;
import com.haoeyou.user.domain.RobotUser;
import com.haoeyou.user.event.CallReceiver;
import com.haoeyou.user.parse.UserProfileManager;
import com.haoeyou.user.utils.PreferenceManager;
