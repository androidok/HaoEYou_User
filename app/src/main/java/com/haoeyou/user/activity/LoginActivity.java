...
public class LoginActivity extends BaseActivity implements LoginActivityView {
    ...
    protected void initEventAndData() {
        ...
        setOnChangeListener();
        mAccount.setText(getIntent().getExtras().getString("ACOUNT"));
    ...
    @OnClick({R.id.title_back, R.id.title_tv, R.id.toolbar_layout, R.id.head_pic, R.id.register, R.id.find_password, 
            R.id.normal_btn, R.id.login_layout})
    public void onViewClicked(View view) {
        ButtonTools.disabledView(view, 1);
        if (view.getId() != R.id.account || view.getId() != R.id.password) {
        ...
        switch (view.getId()) {
            ...
            case R.id.toolbar_layout:
                break;
            case R.id.register:
                RegisterActivity.startAction(mContext, mAccount.getText().toString(), LoginActivity.TAG);
                break;
            case R.id.find_password:
                FindPassActivity.startAction(mContext, mAccount.getText().toString(), LoginActivity.TAG);
                break;
