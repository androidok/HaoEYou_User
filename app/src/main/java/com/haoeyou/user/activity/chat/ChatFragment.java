...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    public boolean onExtendMenuItemClick(int itemId, View view) {
        switch (itemId) {
            ...
            //break;
            case ITEM_LOCATION:
//                ((BaseActivity) getActivity()).checkPermission(new CheckPermListener() {
//                    @Override
//                    public void superPermission() {
                        startActivityForResult(new Intent(getActivity(), EaseBaiduMapActivity.class), REQUEST_CODE_MAP);
//                    }
//                }, R.string.need_location_service, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission
//                        .ACCESS_COARSE_LOCATION);
//                getParentFragment().requestPermissions(new String[]{Manifest.permission.ACCESS_FINE_LOCATION, 
//                        Manifest.permission
